...
public interface UIConstants {
    ...
    Font FONT = FontCache.addFont("PIXM", "fonts/retron2000/Retron2000.ttf");
    Font BAR_LABEL_FONT = FontCache.addFont("PAE", "fonts/retron2000/Retron2000.ttf").deriveFont(16f);
    Font LABEL_FONT = FontCache.addFont("Retron", "fonts/retron2000/Retron2000.ttf").deriveFont(Font.BOLD,18f);
